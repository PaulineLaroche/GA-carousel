class Carousel {
     ...
     * @param {boolean} [options.infinite=false] Doit-on boucler à l'infini en fin de carousel
     * @param {boolean} [options.pagination=false] Doit-on paginer le carousel
     * @param {boolean} [options.navigation=true] Doit-on ajouter les flèches de navigation
     */
